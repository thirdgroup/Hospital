# Generated by Django 2.1 on 2019-05-08 08:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_secret', models.UUIDField(default=uuid.UUID('a7c6c4c0-0a85-4fd2-8df9-f8b08cbe43c6'), verbose_name='用户jwt加密')),
            ],
            options={
                'verbose_name': '用户',
                'db_table': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_items', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='registeritem', to='database.PayItems', verbose_name='关联收费项目')),
            ],
            options={
                'verbose_name': '收费项目登记',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remark', models.CharField(max_length=100, null=True, verbose_name='备注')),
                ('doctor', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='registration', to='database.DoctorManage', verbose_name='关联医生信息')),
            ],
            options={
                'verbose_name': '患者挂号信息',
        ...
        migrations.AddField(
            ...
            name='registration',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='registeritem', to='database.Registration', verbose_name='关联患者挂号信息'),
        ),
        migrations.AddField(
            model_name='dispensing',
            name='registration',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='dispensing', to='database.Registration', verbose_name='关联患者'),
        ),
        migrations.AddField(
            model_name='dispensing',
