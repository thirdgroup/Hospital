# Generated by Django 2.1 on 2019-05-07 09:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_secret', models.UUIDField(default=uuid.UUID('ed7434f4-fa95-4361-9d31-ab185aa9d341'), verbose_name='用户jwt加密')),
            ],
            options={
                'verbose_name': '用户',
                'db_table': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remark', models.CharField(max_length=100, null=True, verbose_name='备注')),
                ('doctor', models.ManyToManyField(related_name='registration', to='database.DoctorManage', verbose_name='关联医生')),
            ],
            options={
                'verbose_name': '病人挂号信息',
